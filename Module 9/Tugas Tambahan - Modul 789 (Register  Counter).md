...
![Real face MAGUS 😱](https://hackmd.io/_uploads/H1nehqOeZg.png)
...
|------------ |----|----|----|-----|-------------|----|----|----|
| Login       | 0  | 0  | 0  |  0  | Input Pass  | ?  | ?  | ?  |
| Login       | 0  | 0  | 0  |  1  | Input Pass  | ?  | ?  | ?  |
| Input Pass  | 0  | 0  | 1  |  0  | Verif Pass  | ?  | ?  | ?  |
| Input Pass  | 0  | 0  | 1  |  1  | Verif Pass  | ?  | ?  | ?  |
| Verif Pass  | 0  | 1  | 0  |  0  | Login       | ?  | ?  | ?  |
| Verif Pass  | 0  | 1  | 0  |  1  | ACC         | ?  | ?  | ?  |
| ACC         | 0  | 1  | 1  |  0  | Change Pass | ?  | ?  | ?  |
| ACC         | 0  | 1  | 1  |  1  | Change Pass | ?  | ?  | ?  |
| Change Pass | 1  | 0  | 0  |  0  | Save Pass   | ?  | ?  | ?  |
| Change Pass | 1  | 0  | 0  |  1  | Save Pass   | ?  | ?  | ?  |
| Save Pass   | 1  | 0  | 1  |  0  | Login       | ?  | ?  | ?  |
| Save Pass   | 1  | 0  | 1  |  1  | Login       | ?  | ?  | ?  |
| ...         | 1  | 1  | 0  |  0  | ...         | X  | X  | X  |
